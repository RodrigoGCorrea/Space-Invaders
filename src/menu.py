...
class Menu(object):
    ...
    def __set_pos(self):
        ...
        self.play.set_position(GVar.WIDTH/2 - self.play.width/2, button_distance)
        self.difc.set_position(GVar.WIDTH/2 - self.play.width/2, 2 * button_distance + self.play.height)
        self.rank.set_position(GVar.WIDTH/2 - self.play.width/2, 3 * button_distance + 2 * self.play.height)
        self.quit.set_position(GVar.WIDTH/2 - self.play.width/2, 4 * button_distance + 3 *self.play.height)
